...
export interface CredentialsOptions {
  ...
  /**
   * If `true`, Khulnasoft.com auth will be required even if Khulnasoft.com credentials have
   * already been set.
   */
  force?: boolean;
}
...
export declare function getKhulnasoftCodegenUsage(
  khulnasoftPublicKey: string,
  khulnasoftPrivateKey: string,
): Promise<KhulnasoftCodegenUsage>;
export declare function getKhulnasoftAuth(
  sys: DevToolsSys,
  preferSpaceId?: string,
): Promise<KhulnasoftAuth>;
