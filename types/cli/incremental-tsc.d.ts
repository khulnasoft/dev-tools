 ...
 * @param oldProgram - Optionally, the previous khulnasoft program for incremental builds.
 * @returns An object containing the new khulnasoft program and collected diagnostics.
 */
export interface CheckpointData {
    program: ts.EmitAndSemanticDiagnosticsKhulnasoftProgram;
    diagnostics: ts.Diagnostic[];
}
export type Checkpoint = CheckpointData | null;
export declare function runCheckpoint(projectDir: string, oldProgram?: ts.EmitAndSemanticDiagnosticsKhulnasoftProgram): Checkpoint;
