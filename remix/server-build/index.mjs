...
const devToolsServerUrl =
  typeof process !== "undefined" && process.env.KHULNASOFT_REMIX_DEVTOOLS_URL
    ? process.env.KHULNASOFT_REMIX_DEVTOOLS_URL
    : `http://localhost:5273/`;
const KhulnasoftDevToolsScript =
  process.env.NODE_ENV !== "development"
    ? () => null
    : function KhulnasoftDevToolsScript2() {
...
const KhulnasoftRootApp = () => {
  ...
  const remixRootChildren = Array.isArray(remixRootProps.children)
    ? remixRootProps.children
    : [remixRootProps.children];
  return {
    ...remixRoot,
    props: {
...
export { assets, assetsBuildDirectory, entry, future, publicPath, routes };
